...
import 'package:course_learning_app/models/question_model.dart';
import 'package:course_learning_app/services/database.dart';
import 'package:course_learning_app/widget/widget.dart';
import 'package:course_learning_app/widgets/Quiz_play_widget.dart';
...
class _QuizPlayState extends State<QuizPlay> {
  ...
  // Future<List<QuizQuestion>> getQuestionModelFromDatasnapshot() async {
  //   List<QuizQuestion> quizQuestions = [];
  //   try {
  //     QuerySnapshot snapshot = await FirebaseFirestore.instance.collection('quiz').get();
  //     quizQuestions = snapshot.docs.map((doc) {
  ...
  QuestionModel getQuestionModelFromDatasnapshot(
    ...
    List<String> options = [
      questionSnapshot.data().toString();
